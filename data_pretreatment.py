...
def main(input_dir, output_dir):
    ...
    for image, filename in cropped_img:
        ...
        for angle in angles:
            rotated_image, rotated_filename = rotate_image(
                resized_img, angle, rows, cols, new_filename
            )
    ...
    for image, filename in rotated_img:
        (
            (high_contrast_img, high_contrast_filename),
            (low_contrast_img, low_contrast_filename),
            (high_bright_img, high_bright_filename),
            (low_bright_img, low_bright_filename),
        ) = img_augmentation(image, filename)
...
output_dir = r"C:\Users\balle\Documents\DSTI\DL\hand_gestures_categorization\resources\output2"
img_dir = r"C:\Users\balle\Documents\DSTI\DL\hand_gestures_categorization\resources\input2"
